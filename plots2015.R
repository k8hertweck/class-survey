...
jpeg(file="figures/2015/evolution.jpg")
par(oma=c(4,4,3,3))
...
jpeg(file="figures/2015/apply.knowledge.jpg")
par(oma=c(4,4,3,3))
...
jpeg(file="figures/2015/stat.tests.jpg")
par(oma=c(4,4,3,3))
...
jpeg(file="figures/2015/improve.data.analysis.jpg")
par(oma=c(4,4,3,3))
...
jpeg(file="figures/2015/manage.files.jpg")
par(oma=c(4,4,3,3))
...
jpeg(file="figures/2015/file.backup.jpg")
par(oma=c(4,4,3,3))
...
jpeg(file="figures/2015/remote.servers.jpg")
par(oma=c(4,4,3,3))
...
jpeg(file="figures/2015/computers.essential.jpg")
par(oma=c(4,4,3,3))
